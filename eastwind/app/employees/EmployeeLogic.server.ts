...
export namespace EmployeesLogic {
    export function start(sb: SchemaBuilder): void {
        ...
        // Southwind's `QueryLogic.Queries.Register(EmployeeQuery.EmployeesByTerritory, …)` — one row per
        // employee/territory pair. Signum flattens `e.Territories`; the source here is the junction row
