...
// because that is where Southwind keeps a domain's module wiring (its process algorithms and scheduled tasks
// are in Orders/OrdersLogic.cs), and because everything here is about ORDER.
//
...
// (`() => GlobalsLogic.configuration().workflow`) exactly as Southwind's call above does.
//
