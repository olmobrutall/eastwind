...
// The wire shape of the ANONYMOUS public catalog (Southwind's `CatalogController.CategoryWithProducts`,
// declared inside the controller and re-declared by hand in PublicCatalog.tsx).
//
...
export interface CategoryWithProducts {
    ...
    /** The category picture's bytes, base64 — Southwind's `byte[]? Picture`, rendered as a data: url. */
    picture: string | null;
    /**
