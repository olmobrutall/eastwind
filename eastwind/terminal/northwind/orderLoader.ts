...
import { OrderEntity, OrderLineEntity, OrderState } from "../../app/orders/Order.data";
import { AddressEmbedded, CompanyEntity, PersonEntity, type CustomerEntity } from "../../app/customers/Customer.data";
import { EmployeeEntity } from "../../app/employees/Employee.data";
    ...
    export async function loadOrders(): Promise<void> {
        ...
        const orders = nwOrders.flatMap(o => {
            ...
            const ord = OrderEntity.create({
                ...
                freight: o.Freight ?? new Decimal(0),
                details,
                isLegacy: true,
