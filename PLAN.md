...
| **D** SQL translator | binder → optimisers → formatter → reader | 🟡 | **Active work — full plan & progress log in [altea/LINQ-Plan.md](altea/LINQ-Plan.md)** (steps 0–4 done; 5–7 incl. navigation/JOIN, collections, Lite, ImplementedBy/ImplementedByAll + SmartEqualizer, groupBy/joins, and string SQL functions landed; live PG 492 / SS 483) |
