...
| **D** SQL translator | binder → optimisers → formatter → reader | 🟡 | **Active work — full plan & progress log in [altea/LINQ-Plan.md](altea/LINQ-Plan.md)** (steps 0–4 done, 5–6 in progress) |
